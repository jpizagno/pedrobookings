...
class ProductRow extends React.Component {
    ...
    render() {
        ...
        return (
            <tr >
                <EditableCell isMainCell={true} onProductTableUpdate={this.props.onProductTableUpdate} cellData={{
                    "type": "month_jahr",
                    value: this.props.product.month_jahr,
                    id: this.props.product.id
                }}/>
                <EditableCell isMainCell={false} onProductTableUpdate={this.props.onProductTableUpdate} cellData={{
                    type: "einnahme_netto",
